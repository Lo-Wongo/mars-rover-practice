...
.service('marsSrv' , function($http){
    const baseURL = 'https://api.nasa.gov/mars-photos/api/v1/rovers/curiosity/photos?earth_date=2017-5-3&api_key=';
    ...
    let weatherURL = 'http://marsweather.ingenology.com/v1/latest/';
